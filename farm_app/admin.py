...
from .models import ExtendedUser, FarmerDetail, Land, LandApplication, LandAgreement, Product, Image, Storage, StorageApplications
...
admin.site.register(StorageApplications)
